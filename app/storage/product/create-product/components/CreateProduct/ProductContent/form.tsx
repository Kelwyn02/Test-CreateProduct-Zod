                        ...
                        <div className="bg-neutral-800 p-2 rounded-sm border border-neutral-700">
                            <div className="flex items-center flex-wrap gap-x-2 gap-y-1">
                                ...
                                <div className="flex pr-2">
                                    ...
                                    a  <Button type="button" variant="ghost" size="icon" className="h-8 w-8 text-neutral-400 hover:bg-neutral-700">
                                ...
                                <div className="flex gap-x-1">
                                    <Button type="button" variant="ghost" size="icon" className="h-8 w-8 text-neutral-400 hover:bg-neutral-700">
                                        A      <ListIcon className="h-4 w-4" />
                                    </Button>
                                    <Button type="button" variant="ghost" size="icon" className="h-8 w-8 text-neutral-400 hover:bg-neutral-700">
                                        <ListOrderedIcon className="h-4 w-4" />
                                    </Button>
                                    <Button type="button" variant="ghost" size="icon" className="h-8 w-8 text-neutral-400 hover:bg-neutral-700">
                                        _   <LinkIcon className="h-4 w-4" />
                                    </Button>
                                    <Button type="button" variant="ghost" size="icon" className="h-8 w-8 text-neutral-400 hover:bg-neutral-700">
